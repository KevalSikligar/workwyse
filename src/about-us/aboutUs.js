                                    ...
                                    <div class="mb-lg-0 mb-4">
                                        <div class="service-card text-center">
                                            ...
                                            <div class="servic-data mt-3">
                                                ...
                                                <p class="text-muted mb-0">Reference site about Generate Account, giving information on its origins, as well as a random acc generator.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-lg-0 mb-4">
                                        <div class="service-card text-center">
                                            ...
                                            <div class="servic-data mt-3">
                                                ...
                                                <p class="text-muted mb-0">Reference site about Technical Issues, giving information on its origins, as well as a random technical generator.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-lg-0 mb-4">
                                        <div class="service-card text-center">
                                            ...
                                            <div class="servic-data mt-3">
                                                ...
                                                <p class="text-mute mb-0">Reference site about Billing Inquiries, giving information on its origins, as well as a random billing psum generator. </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
