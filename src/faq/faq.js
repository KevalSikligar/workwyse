                        ...
                        <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <div class="card-body">                                        
                                        ...
                                        <ul>
                                            ...
                                            <li>Send a presonalised message directly to Sellers</li>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <h2 class="mb-0">
                                        <button type="button" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo"> How does it works for sellers? <i class="fa fa-plus"></i></button>
                                    </h2>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                    <div class="card-body">
                                        ...
                                        <p>We only charge for 'Replay to Hire' leads. These cost $5 each with the billing cycle at the end of each week. You can update your billing details under 'Billing' in the Settings menu. (See 'Pricing')</p>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                    <div class="card-body">
                                        ...
                                        <p>File links can be uploaded cia Google Drive or Dropbox.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header" id="headingFour">
                                    <h2 class="mb-0">
                                        <button type="button" class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour"> What is the (WWI) WorkWyseIndex ratinf and how are profiles rated? <i class="fa fa-plus"></i></button> 
                                    </h2>
                                </div>
