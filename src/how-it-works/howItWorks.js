                ...
                <div>
                    <div className="sptb bg-white">
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col-lg-12 col-md-12 col-sm-12 hiw-video-section">
                    ...
                    <div className="sptb">
                        <div className="container">
                            <div className="section-title center-block text-center pb-7">
                                <h1>HOW DOES WORKWYSE WORK? ITS VERY SIMPLE</h1>
                                <p>Our powerful engine in the back room matches your requirements with firms that are able to cover your most important needs.</p>
                            </div>
                            <div className="row">
                                <div className="col-lg-4 col-md-4 col-sm-12 col-12">
                                    <div className="hiw-poster">
                                        <img src={require('../assets/images/hiw-volunteer.png')} alt="img" />
                                    </div>
                                </div>
                                <div className="col-lg-8 col-md-8 col-sm-12 col-12">
                                    <div className="steps-item">
                                        <div className="steps-title"><span>1</span> Search</div>
                                    ...
                                    <div className="steps-item">
                                        <div className="steps-title"><span>2</span> Speak</div>
                                        <div className="steps-desc">
                                    ...
                                    <div className="steps-item">
                                        <div className="steps-title"><span>3</span> Select</div>
                                        <div className="steps-desc">
