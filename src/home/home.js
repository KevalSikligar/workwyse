                                        ...
                                        <div className="search-background bg-transparent breadcrumb-search">
                                            <div className="form row no-gutters">
                                                ...
                                                <div className="col-xl-3 col-lg-3 col-md-4 mb-0">
                                                    <Link className="btn btn-lg btn-block btn-success br-tl-md-0 br-bl-md-0" onClick={() => this.toggleModal()}><i className="fa fa-search mr-1"></i>Post A Project</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="single-page">
                                        <div className="wrapper wrapper2">
                                            <div className="p-4 mb-4">
                                                ...
                                                <div className="btn-list d-sm-flex" className="LinkedIn-btn">
                                                    <SignInLinkedIn />
                                                </div>
                                            </div>
