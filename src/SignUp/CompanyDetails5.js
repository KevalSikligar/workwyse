        ...
        return (
            <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 sptb custom-card review-sec">
                                    ...
                                    <div className="row">
                                        <div className="col-md-12 col-sm-12">
                                            <div className="info-section mw-100">
                                                <p className="text-dark fs-18 mb-0">Connecting review sites increases the ranking of your posts, ensuring a swifter response from our Sellers. You can complete this step anytime via Settings.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
