                                        ...
                                        <div className="col-sm-12 col-md-12">
                                            ...
                                            <div className="custom-controls-stacked rdb-steps-1">
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6 col-md-6">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="text" className="form-control" placeholder="Number" value="654321" />
                                                        </div>
                                                    </div>
                                                    <div className="col-sm-6 col-md-6">
                                                        <div className="form-group">
                                                ...
                                                <div className="row">
                                                    <div className="col-sm-6 col-md-6">
                                                        <div className="form-group">
                                                            <label className="form-label">Service Foucs</label>
                                                            <select className="form-control">
                                                    ...
                                                    <div className="col-sm-6 col-md-6">
                                                        <div className="form-group">
                                                            <label className="form-label">Industry Foucs</label>
                                                            <select className="form-control">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-sm-6 col-md-6">
                                                        <div className="form-group">
                                                            <label className="form-label">Company LinkedIn Link</label>
                                                            <input type="text" className="form-control" placeholder="VAT Number" value="www.linkedin.com/company/marketing-inc/" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="row">
                                                    <div className="col-sm-6 col-md-6">
                                                        <div className="form-group">
                                                            <label className="form-label">Company Twitter Link</label>
                                                            <input type="text" className="form-control" placeholder="Number" value="www.twitter.com/profile/marketing-inc/" />
                                                        </div>
                                                    </div>
                                                    <div className="col-sm-6 col-md-6">
                                                        <div className="form-group">
                                                            <label className="form-label">Company Protfolio Link</label>
                                                            <input type="text" className="form-control" placeholder="VAT Number" value="www.marketing.inc/portfolio" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
